...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HelloWorldJs = __webpack_require__(160);
	...
	var App = (function (_React$Component) {
		...
		App.prototype.render = function render() {
			return _react2['default'].createElement(_HelloWorldJs2['default'], { user: 'world', id: '12345' });
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uuidV1 = __webpack_require__(186);

	var _uuidV12 = _interopRequireDefault(_uuidV1);
	...
	var TodoApp = (function (_React$Component) {
		...
		function TodoApp(props) {
			...
			this.handleClick = function () {
				...
				_axios2['default'].post('https://5bq2v7mgi5.execute-api.us-east-1.amazonaws.com/prod/worskshopExample2', {
					'Item': {
						userId: _uuidV12['default'](),
			...
			this.handleChangeName = function (event) {
				_this.setState({
					name: event.target.value
				});
			};

			this.handleChangeEmail = function (event) {
				_this.setState({
		...
		TodoApp.prototype.componentDidMount = function componentDidMount() {
			...
			_axios2['default'].get('https://5bq2v7mgi5.execute-api.us-east-1.amazonaws.com/prod/worskshopExample2?TableName=g0v-workshop').then(function (response) {
				_this2.setState({
		...
		TodoApp.prototype.render = function render() {
			...
			var signeeList = this.state.signeeList.map(function (signee) {
			...
			return _react2['default'].createElement(
				...
				this.state.isSuccess && _react2['default'].createElement(
					'p',
					null,
					' 感謝你參與連署！ '
				),
